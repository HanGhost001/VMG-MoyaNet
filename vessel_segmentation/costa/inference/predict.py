# ================================================================
# REFERENCE COPY - DO NOT RUN DIRECTLY
#
# This is a reference copy of the COSTA vessel segmentation
# inference code. It requires the COSTA and nnUNet packages
# to be installed in order to run.
#
# To perform vessel segmentation, use the wrapper script:
#   python vessel_segmentation/segment_vessels.py -i <input> -o <output>
#
# Or install COSTA directly:
#   pip install nnunet
#   # Follow: https://github.com/iMED-Lab/COSTA
#
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    # Windows compatibility: use single-threaded processing when num_processes <= 1
    if num_processes <= 1:
        for i, l in enumerate(list_of_lists):
            try:
                output_file = output_files[i]
                ...
                d = d.transpose([0] + [i + 1 for i in transpose_forward])
